...
curl -X POST http://localhost:8080/events/track --data "event_type=pageview&external_user_id=generated_id_123&page=home&experiment_homepage_v1=control"
echo ""
...
curl -X POST http://localhost:8080/events/track --data "event_type=signup&external_user_id=generated_id_123&experiment_signup_v1=control"
echo ""
...
curl -X POST http://localhost:8080/events/batch_track --data "events=[
{
  ...
  event_type: 'pageview',
  experiment_homepage_v1: 'new console',
  page: 'home'
}, {
  external_user_id: 'chengtao+1@codecademy.com',
  event_type: 'signup',
  experiment_signup_v1: 'fancy onboarding'
}, {
  external_user_id: 'chengtao+1@codecademy.com',
...
curl -X POST "http://localhost:8080/events/funnel" --data "start_date=${today}&end_date=${end_date}&funnel_steps[]=pageview&funnel_steps[]=signup&num_days_to_complete_funnel=7&efk0=experiment_homepage_v1&efv0=control&efk0=page&efv0=home"
echo ""

echo -e "\033[1;32mshow A/B testing signup funnel (new console):\033[0m pageview -> signup"
curl -X POST "http://localhost:8080/events/funnel" --data "start_date=${today}&end_date=${end_date}&funnel_steps[]=pageview&funnel_steps[]=signup&num_days_to_complete_funnel=7&efk0=experiment_homepage_v1&efv0=new console&efk0=page&efv0=home"
echo ""

echo -e "\033[1;32mshow A/B testing cohort:\033[0m signup -> submission"
curl -X POST "http://localhost:8080/events/cohort" --data "start_date=${today}&end_date=${end_date}&row_event_type=signup&column_event_type=submission&num_days_per_row=7&num_columns=2&refk=experiment_signup_v1&refv=control"
echo ""

echo -e "\033[1;32mshow A/B testing cohort:\033[0m signup -> submission"
curl -X POST "http://localhost:8080/events/cohort" --data "start_date=${today}&end_date=${end_date}&row_event_type=signup&column_event_type=submission&num_days_per_row=7&num_columns=2&refk=experiment_signup_v1&refv=fancy onboarding"
echo ""
