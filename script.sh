...
curl -X POST "http://localhost:8080/count_funnel_steps" --data "start_date=20130101&end_date=20130103&funnel_steps[]=signup&funnel_steps[]=view_shopping_cart&funnel_steps[]=checkout&num_days_to_complete_funnel=7&eck=event_property_1&ecv=1&uck=user_property_1&ucv=1"
curl -X POST "http://localhost:8080/count_funnel_steps" --data "start_date=20130101&end_date=20130103&funnel_steps[]=signup&funnel_steps[]=view_shopping_cart&funnel_steps[]=checkout&num_days_to_complete_funnel=7&eck=event_property_1&ecv=1&uck=user_property_1&ucv=2"
